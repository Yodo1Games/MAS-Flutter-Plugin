        ...
        switch (call.method) {
            ...
            case METHOD_NATIVE_SHOW_AD: {
                ...
                if (type != null) {
                    switch (type) {
                        case "Reward": {
                            Yodo1Mas.getInstance().showRewardedAd(TestmasfluttersdktwoPlugin.this.activity);
                            break;
                        }
                        case "Interstitial": {
                            Yodo1Mas.getInstance().showInterstitialAd(TestmasfluttersdktwoPlugin.this.activity);
                            break;
                        }
                        case "Banner": {
